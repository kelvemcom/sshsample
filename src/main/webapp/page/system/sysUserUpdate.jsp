...
<body>
	...
	<form id="update" action="page/system/sysUser_sysUserUpdateDone.action" method="get">
			...
			<div class="row-fluid">
				<div class="span9">
					<table id='list' class="table table-bordered table-hover table-striped datatable">
						...
						<c:if test="${!empty sysUser}">
							<tr><td class='info'>用户ID</td><td><input type="text" readonly="readonly" name="sysUser.sysUserId" value="${sysUser.sysUserId}"></td></tr>
							<tr><td class='info'>用户显示名</td><td><input type="text" name="sysUser.sysUserName" value="${sysUser.sysUserName}"></td></tr>
							<tr><td class='info'>用户登录名</td><td><input type="text" name="sysUser.userLogonName" value="${sysUser.userLogonName}"></td></tr>
							<tr><td class='info'>密码</td><td><input type="text" name="sysUser.userPassword" value="${sysUser.userPassword}"></td></tr>
							<tr><td class='info'>用户类型</td><td><input type="text" name="sysUser.userTypeCode" value="${sysUser.userTypeCode}"></td></tr>
							<tr><td class='info'>人个信息ID</td><td><input type="text" name="sysUser.personInfoId" value="${sysUser.personInfoId}"></td></tr>
							<tr><td class='info'>描述</td><td><input type="text" name="sysUser.userDescs" value="${sysUser.userDescs}"></td></tr>
							<tr><td class='info'>状态标志</td><td><input type="text" name="sysUser.statusCode" value="${sysUser.statusCode}"></td></tr>
							<tr><td class='info'>状态修改时间</td><td><input type="text" name="sysUser.statusChangeTime" value="${sysUser.statusChangeTime}"></td></tr>
							<tr><td class='info'>删除标志</td><td><input type="text" name="sysUser.delFlag" value="${sysUser.delFlag}"></td></tr>
							<tr><td class='info'>删除时间</td><td><input type="text" name="sysUser.delTime" value="${sysUser.delTime}"></td></tr>
							<tr><td class='info'>创建时间</td><td><input type="text" name="sysUser.createTime" value="${sysUser.createTime}"></td></tr>
							<tr><td class='info'>更新时间</td><td><input type="text" name="sysUser.updateTime" value="${sysUser.updateTime}"></td></tr>
						</c:if>
						</tbody>
					</table>
				</div>
