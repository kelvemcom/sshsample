 ...
 * 文件：com.kelvem.sample.system.model.UserVisitLogModel.java
 * 所含类: UserVisitLogModel.java
 * 修改记录：
 * 日期				作者						内容
 * =============================================================
 ...
 * 
 * @ClassName UserVisitLogModel
 * @author kelvem
 * @version 1.0
 */
public class UserVisitLogModel implements java.io.Serializable {
